...
**3**. Create a Github profile of your own (if you don't have any) and try to upload one of the exercise notebooks you have done in this course. **Hint**: See section [4.2.2](https://pykale.github.io/transparentML/04-hypo-test-sw-dev/software-development.html#github-for-software-development)
